...
print(f"Premature UPDATE/KEEPALIVE before OPEN (Silent Drop): {premature_bugs}")
print(f"UPDATE sent AFTER OPEN (Established State): {established_bugs}")
print(f"Other edge cases: {other_bugs}")
